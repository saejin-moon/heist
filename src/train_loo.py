r"""
LOO (Leave-One-Out / C3-Style Counterfactual PPO) trainer for HEIST.

Implements Leave-One-Out marginal counterfactual advantage (C3-style):
...
def parse_args():
    ...
    parser.add_argument("--exp-name", type=str, default="loo")
...
def train(args):
    ...
    for update in range(1, num_updates + 1):
        ...
        # Compute Q targets & LOO advantages
        ...
        for _epoch in range(args.update_epochs):
            ...
            for start in range(0, batch_size, minibatch_size):
                ...
                for _idx_a, a in enumerate(AGENTS):
                    ...
                    adv_unrouted, q_taken = compute_loo_advantage(
                        q_vals_all, act_mb, mask_mb
                    )
                    adv = adv_unrouted
